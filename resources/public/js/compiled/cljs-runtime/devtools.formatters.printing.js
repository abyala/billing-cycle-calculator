...
var G__42100 = (i__4737__auto___42099 + (1));
i__4737__auto___42099 = G__42100;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42045){
var G__42046 = cljs.core.first(seq42045);
var seq42045__$1 = cljs.core.next(seq42045);
var G__42047 = cljs.core.first(seq42045__$1);
var seq42045__$2 = cljs.core.next(seq42045__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42046,G__42047,seq42045__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42068_SHARP_){
return (!((cljs.core.meta(p1__42068_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42077__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42083){var _e__40858__auto__ = e42083;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e42085){var _e__40858__auto__ = e42085;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42088 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42089 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42089);

try{var map__42090 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42090__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42088);
}});
...
var temp__5733__auto___42109 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___42109)){
var managed_print_level_42110 = temp__5733__auto___42109;
var _STAR_print_level_STAR__orig_val__42093_42111 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42094_42112 = managed_print_level_42110;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42094_42112);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42092_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42092_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42093_42111);
}} else {
job_fn();
}
