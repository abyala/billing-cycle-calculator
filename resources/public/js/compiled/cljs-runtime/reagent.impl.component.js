...
if((i < len)){
var k = (ks[i]);
var G__49925 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__49926 = (i + (1));
m = G__49925;
i = G__49926;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__49716 = c;
var G__49716__$1 = (((G__49716 == null))?null:G__49716.prototype);
if((G__49716__$1 == null)){
return null;
} else {
return G__49716__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__49722 = c;
var G__49722__$1 = (((G__49722 == null))?null:G__49722.prototype);
if((G__49722__$1 == null)){
return null;
} else {
return G__49722__$1.render;
}
})() == null)))));
});
...
var G__49751 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__49751) : reagent.impl.component.as_element.call(null,G__49751));
};
...
var G__49753 = c;
var G__49753__$1 = (((G__49753 == null))?null:G__49753.constructor);
if((G__49753__$1 == null)){
return null;
} else {
return G__49753__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__49763 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__49764 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__49764);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__49763);
}});
...
var c = this;
var G__49809_49986 = goog.object.get(c,"cljsRatom");
if((G__49809_49986 == null)){
} else {
reagent.ratom.dispose_BANG_(G__49809_49986);
}
...
var renders_49999 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_50000 = cljs.core.first(cljs.core.vals(renders_49999));
...
if((cljs.core.count(renders_49999) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_49999))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_50000)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_50000], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__49836 = o;
goog.object.set(G__49836,cljs.core.name(k),v);
