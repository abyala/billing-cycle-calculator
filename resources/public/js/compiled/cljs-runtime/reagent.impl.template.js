...
var G__49975 = o;
goog.object.set(G__49975,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__50151__delegate = function (args){
...
while (G__50153__i < G__50153__a.length) {G__50153__a[G__50153__i] = arguments[G__50153__i + 0]; ++G__50153__i;}
  args = new cljs.core.IndexedSeq(G__50153__a,0,null);
} 
return G__50151__delegate.call(this,args);};
G__50151.cljs$lang$maxFixedArity = 0;
G__50151.cljs$lang$applyTo = (function (arglist__50154){
var args = cljs.core.seq(arglist__50154);
return G__50151__delegate(args);
});
...
var G__49989 = o;
goog.object.set(G__49989,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__50172__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__50173__i < G__50173__a.length) {G__50173__a[G__50173__i] = arguments[G__50173__i + 0]; ++G__50173__i;}
  args = new cljs.core.IndexedSeq(G__50173__a,0,null);
} 
return G__50172__delegate.call(this,args);};
G__50172.cljs$lang$maxFixedArity = 0;
G__50172.cljs$lang$applyTo = (function (arglist__50174){
var args = cljs.core.seq(arglist__50174);
return G__50172__delegate(args);
});
...
var G__50003 = props;
var G__50003__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50003,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__50003);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50003__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__50003__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__50006 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50006,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__50006;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__50013){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50014__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__50030_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__50030_SHARP_);
}));
} else {
return null;
}
...
var vec__50040 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50040,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50040,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50040,(2),null);
...
var temp__5739__auto___50209 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___50209 == null)){
} else {
var key_50210 = temp__5739__auto___50209;
(jsprops.key = key_50210);
}
...
var temp__5739__auto___50211 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___50211 == null)){
} else {
var key_50212 = temp__5739__auto___50211;
(jsprops.key = key_50212);
}
...
var G__50072 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__50072) : reagent.impl.template.as_element.call(null,G__50072));
} else {
var temp__5739__auto___50219 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___50219 == null)){
} else {
var key_50220 = temp__5739__auto___50219;
(jsprops.key = key_50220);
}
...
var G__50083 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__50083)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__50083)){
return x;
} else {
...
var len__4736__auto___50221 = arguments.length;
var i__4737__auto___50222 = (0);
while(true){
if((i__4737__auto___50222 < len__4736__auto___50221)){
args__4742__auto__.push((arguments[i__4737__auto___50222]));

var G__50223 = (i__4737__auto___50222 + (1));
i__4737__auto___50222 = G__50223;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq50086){
var G__50087 = cljs.core.first(seq50086);
var seq50086__$1 = cljs.core.next(seq50086);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50087,seq50086__$1);
}));
...
break;
default:
var G__50226 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__50226;
continue;
...
var ctx = ({});
var vec__50112 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50112,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50112,(1),null);
...
var G__50127 = (cljs.core.count(argv) - first_child);
switch (G__50127) {
case (0):
