...
var o41563 = temp__5733__auto__;
var temp__5733__auto____$1 = (o41563["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o41564 = temp__5733__auto____$1;
return (o41564["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40829__auto__ = f;
return (o__40829__auto__["toString"]).call(o__40829__auto__);
} else {
return "";
}
}catch (e41570){var _ = e41570;
return "";
}});
...
try{var o__40829__auto___41973 = t;
(o__40829__auto___41973["cljs$lang$ctorPrWriter"]).call(o__40829__auto___41973,t,writer);
}catch (e41583){var __41974 = e41583;
}
...
var char_code = (function (){var o__40829__auto__ = (new String(char$));
return (o__40829__auto__["charCodeAt"]).call(o__40829__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40829__auto__ = String;
return (o__40829__auto__["fromCharCode"]).call(o__40829__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41615 = num_code;
switch (G__41615) {
case (1):
return (185);
...
var o__40829__auto__ = String;
return (o__40829__auto__["fromCharCode"]).call(o__40829__auto__,superscript_code);
});
/**
...
}catch (e41645){var _e__40858__auto__ = e41645;
return false;
}})())){
...
var vec__41648 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41648,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41701){
var vec__41702 = p__41701;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41702,(0),null);
...
var G__42011 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__42012 = cljs.core.butlast(remaining_tokens);
name_tokens = G__42011;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41678){
var G__41679 = cljs.core.first(seq41678);
var seq41678__$1 = cljs.core.next(seq41678);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41679,seq41678__$1);
}));
...
var vec__41740 = cljs.core.split_with((function (p1__41733_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__41733_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41740,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41740,(1),null);
...
var vec__41759 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41759,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41759,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__42015 = cljs.core.rest(remaining_tokens);
var G__42016 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__42015;
name_tokens = G__42016;
continue;
} else {
...
var vec__41771 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41771,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41771,(1),null);
var vec__41774 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41774,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41774,(1),null);
var vec__41777 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41777,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41777,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41777,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41777,(3),null);
...
var vec__41797 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41797,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41797,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41797,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41797,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41797,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41797,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__41802 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41802,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41802,(1),null);
var vec__41805 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41805,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41805,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__41815 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__41815) : devtools.munging.parse_fn_info_deep.call(null,G__41815));
})()));
}
} else {
return fn_info;
...
var G__42038 = (arity + (1));
var G__42039 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__41839){
var vec__41840 = p__41839;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41840,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41840,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41852_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__41852_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41854_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__41854_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__41864){
var vec__41865 = p__41864;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41865,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq41858){
var G__41859 = cljs.core.first(seq41858);
var seq41858__$1 = cljs.core.next(seq41858);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41859,seq41858__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41899__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41899__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41899__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41899__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__41900 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41900,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41900,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41900,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41900,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41900,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41900,(5),null);
...
var o__40829__auto__ = f;
return (o__40829__auto__["getBasis"]).call(o__40829__auto__);
});
/**
...
}catch (e41922){var _e__40858__auto__ = e41922;
...
var G__42069 = (obj[cljs.core.first(path)]);
var G__42070 = cljs.core.rest(path);
obj = G__42069;
path = G__42070;
continue;
} else {
...
var _STAR_ = (function (accum,p__41939){
var vec__41941 = p__41939;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41941,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41941,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__41949){
var vec__41950 = p__41949;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41950,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41950,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41950,(2),null);
...
var post_process = (function (p__41959){
var vec__41960 = p__41959;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41960,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41960,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41957_SHARP_){
return (obj[cljs.core.first(p1__41957_SHARP_)]);
}),sorted_matches);
