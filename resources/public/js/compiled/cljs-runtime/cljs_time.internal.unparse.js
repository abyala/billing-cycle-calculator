...
var periods__$1 = cljs.core.vec((function (){var G__43216 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43215_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__43215_SHARP_,(0),(3));
}),G__43216);
} else {
return G__43216;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__43226){
var vec__43228 = p__43226;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43228,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43228,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__43231 = pattern;
switch (G__43231) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__43231)].join('')));
...
return p1__43232_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__43233_SHARP_){
return p1__43233_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__43234_SHARP_){
return p1__43234_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__43235_SHARP_){
return p1__43235_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__43236_SHARP_){
return p1__43236_SHARP_.getHours();
});

break;
case "day":
return (function (p1__43237_SHARP_){
return p1__43237_SHARP_.getDate();
});

break;
case "month":
return (function (p1__43238_SHARP_){
return p1__43238_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__43239_SHARP_){
return p1__43239_SHARP_.getYear();
});
...
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__43241){
var vec__43242 = p__43241;
var seq__43243 = cljs.core.seq(vec__43242);
var first__43244 = cljs.core.first(seq__43243);
var seq__43243__$1 = cljs.core.next(seq__43243);
var key = first__43244;
var args = seq__43243__$1;
var G__43245 = key;
...
break;
case "ordinal-suffix":
var vec__43246 = (function (){var G__43249 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__43249) : syntax_list.call(null,G__43249));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43246,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__43245__$1)].join('')));
...
var d = value;
var G__43253 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__43254 = G__43253;
...
var unparser = first__43256;
var more = seq__43255__$1;
var s = "";
var d__$1 = d;
var G__43253__$1 = G__43253;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__43263 = G__43253__$1;
...
var unparser__$1 = first__43265;
var more__$1 = seq__43264__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__43266 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43266,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43266,(1),null);
var G__43301 = d__$3;
var G__43302 = more__$1;
var G__43303 = s__$3;
d__$1 = G__43301;
G__43253__$1 = G__43302;
s__$1 = G__43303;
continue;
}
break;
