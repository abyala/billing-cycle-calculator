...
return [(function (){var pred__50716 = cljs.core.instance_QMARK_;
var expr__50717 = reactive_val;
if(cljs.core.truth_((pred__50716.cljs$core$IFn$_invoke$arity$2 ? pred__50716.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__50717) : pred__50716.call(null,reagent.ratom.RAtom,expr__50717)))){
return "ra";
} else {
if(cljs.core.truth_((pred__50716.cljs$core$IFn$_invoke$arity$2 ? pred__50716.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__50717) : pred__50716.call(null,reagent.ratom.RCursor,expr__50717)))){
return "rc";
} else {
if(cljs.core.truth_((pred__50716.cljs$core$IFn$_invoke$arity$2 ? pred__50716.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__50717) : pred__50716.call(null,reagent.ratom.Reaction,expr__50717)))){
return "rx";
} else {
if(cljs.core.truth_((pred__50716.cljs$core$IFn$_invoke$arity$2 ? pred__50716.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__50717) : pred__50716.call(null,reagent.ratom.Track,expr__50717)))){
return "tr";
} else {
return "other";
}
